...
?>
	<table class="table">
		...
		<tr>
			...
			<td><?php echo "". $book['book_price']."tk"; ?></td>
			<td><?php echo $qty; ?></td>
			<td><?php echo "". $qty * $book['book_price']."tk"; ?></td>
		</tr>
		<?php } ?>
		<tr>
			<th>&nbsp;</th>
			...
			<th><?php echo "". $_SESSION['total_price']."tk"; ?></th>
		</tr>
		<tr>
			<td>Shipping</td>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<th>&nbsp;</th>
			<th>&nbsp;</th>
			<th><?php echo "". ($_SESSION['total_price'] + 20)."tk"; ?></th>
		</tr>
	</table>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
              	<select class="form-control" name="card_type">
                  	<option value="VISA">Bkash</option>
                  	<option value="MasterCard">Rocket</option>
                  	<option value="American Express">Dutch Bangla</option>
              	</select>
            </div>
        </div>
        <div class="form-group">
